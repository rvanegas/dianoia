"""TypedDict schemas for agent result_content fields.

Each class corresponds to the result_content produced by one agent type.
Derived from the response_format_base dicts in services/agent_prompts.py —
update both together when changing an agent's output schema.
"""
