...
class TestDualEvaluators:
    ...
    def test_content_evaluator(self):
        ...
        mock_response = {
            "truth_evaluations": [
                {"symbol": "1", "truth_value": 0.9, "reasoning": "Historical fact"},
                {"symbol": "2", "truth_value": 0.95, "reasoning": "Universal biological truth"},
                {"symbol": "3", "truth_value": 0.9, "reasoning": "Valid conclusion from premises"}
            ],
        ...
        with patch('services.agents.agent_gpt_evaluate_content') as mock_gpt:
            ...
            agent_data = AgentData(
                ...
                argument=[
                    ...
                    Step(symbol="3", proposition="Socrates is mortal", justifiers=["1", "2"], truth_score="1.0", valid="1.0")
                ],
                latest_results=[],
    ...
    def test_form_evaluator(self):
        ...
        with patch('services.agents.agent_gpt_evaluate_form') as mock_gpt:
            ...
            agent_data = AgentData(
                assumptions=[],
                argument=[
                    Step(symbol="1", proposition="All men are mortal", justifiers=[], truth_score="1.0", valid="1.0",
                        formalization=Formalization(ascii="forall x. P(x) implies Q(x)", endorsed=True)),
                    Step(symbol="2", proposition="Socrates is a man", justifiers=[], truth_score="1.0", valid="1.0",
